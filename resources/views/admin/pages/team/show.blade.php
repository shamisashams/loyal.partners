                ...
                <div class="display-flex media">
                    <div class="media-body">
                        <h6 class="media-heading">
                            <span class="users-view-name">{{$team->full_name}} </span>
                        </h6>
                    </div>
                </div>
            </div>
                            ...
                            <div id="cat-{{$locale}}"
                                ...
                                <table class="striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$team->translate($locale)->full_name ?? ''}}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$team->translate($locale)->experience ?? ''}}</td>
                                    </tr>
                                    <tr>
                                        <td>@lang('admin.education'):</td>
                                        <td>{{$team->translate($locale)->education ?? ''}}</td>
                                    </tr>
                                    <tr>
                                        <td>@lang('admin.bottom_text'):</td>
                                        <td>{{$team->translate($locale)->bottom_text ?? ''}}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
